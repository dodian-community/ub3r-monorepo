...
This is the category in which you'll find documentation on how to set things up, and in general find guides on basic usage of the Ub3r repository.
...
<ul>
    <li><a href="/docs/contribution">Guides</a>
        <ul>
            ...
            <li><a href="/docs/guides/task_coroutine_system.md">Task Coroutine System Guide</a></li>
        </ul>
    </li>
