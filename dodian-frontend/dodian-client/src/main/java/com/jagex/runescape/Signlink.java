...
public class Signlink implements Runnable {
    ...
    public static String findcachedir() {
        String[] as = {System.getProperty("user.home") + File.separator + ".dodian-net", "./cache", "./data/cache"};

        if (storeid != -1 && ((storeid < 32) || (storeid > 34)))
            storeid = 32;
        ...
        return System.getProperty("user.home") + File.separator + ".dodian-net/";
    }
