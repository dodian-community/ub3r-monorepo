...
public class Game extends GameShell {
    ...
    public URL getCodeBase() {
        try {
            return new URL("http://" + server + ":" + (Game.httpPort + portOffset));
    ...
    public static int gamePort = 43594;
    public static int filePort = 43595;
    ...
    public void login(String username, String password, boolean reconnect) {
        try {
            ...
            connection = new Connection(this, openSocket(Game.gamePort + portOffset));
    ...
    public DataInputStream openURL(String s) throws IOException {
        ...
        jaggrabSocket = openSocket(Game.filePort);
