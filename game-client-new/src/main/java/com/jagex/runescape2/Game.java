package com.jagex.runescape2;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
public class Game extends GameShell {
    ...
    public static boolean crc32Check = true;
    ...
    public FileArchive loadArchive(int fileId, String caption, String fileName, int expectedChecksum, int progress) throws IOException {
        ...
        while (data == null) {
            ...
            try {
                ...
                DataInputStream in;
                if (crc32Check) {
                    in = openURL(fileName + expectedChecksum);
                } else {
                    in = openURL(fileName);
                }
