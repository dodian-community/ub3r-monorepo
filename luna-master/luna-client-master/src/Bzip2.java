...
public class Bzip2 {
	...
	public static int decompress(byte abyte0[], int i, byte abyte1[], int j, int k) {
		synchronized (ctx) {
			ctx.aByteArray47 = abyte1;
			ctx.anInt48 = k;
			ctx.aByteArray52 = abyte0;
			ctx.anInt53 = 0;
			ctx.anInt49 = j;
			ctx.anInt54 = i;
			ctx.anInt61 = 0;
	...
	public static void method314(Bzip2Context class1) {
		...
		boolean flag19 = true;
		while (flag19) {
			byte byte0 = method315(class1);
			if (byte0 == 23)
				return;
			byte0 = method315(class1);
			byte0 = method315(class1);
			byte0 = method315(class1);
			byte0 = method315(class1);
			byte0 = method315(class1);
			...
			int j4 = method317(3, class1);
			int k4 = method317(15, class1);
			for (int i1 = 0; i1 < k4; i1++) {
				int j3 = 0;
				do {
					byte byte3 = method316(class1);
					if (byte3 == 0)
						break;
					j3++;
				} while (true);
			...
			for (int k3 = 0; k3 < j4; k3++) {
				int l6 = method317(5, class1);
				for (int k1 = 0; k1 < i4; k1++) {
					do {
						byte byte4 = method316(class1);
						if (byte4 == 0)
							break;
						byte4 = method316(class1);
						if (byte4 == 0)
							l6++;
						else
							l6--;
			...
			for (int l3 = 0; l3 < j4; l3++) {
				...
				method319(class1.anIntArrayArray81[l3], class1.anIntArrayArray82[l3], class1.anIntArrayArray83[l3],
						class1.aByteArrayArray80[l3], byte8, i, i4);
			...
			int l7;
			byte byte9;
			for (l7 = method317(i7, class1); l7 > ai[i7]; l7 = l7 << 1 | byte9) {
				i7++;
				byte9 = method316(class1);
			}
			...
			for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
				if (k5 == 0 || k5 == 1) {
					...
					do {
						...
						int i8;
						byte byte10;
						for (i8 = method317(j7, class1); i8 > ai[j7]; i8 = i8 << 1 | byte10) {
							j7++;
							byte10 = method316(class1);
						}
					...
					int j8;
					byte byte11;
					for (j8 = method317(k7, class1); j8 > ai[k7]; j8 = j8 << 1 | byte11) {
						k7++;
						byte11 = method316(class1);
					}
	...
	public static Bzip2Context ctx = new Bzip2Context();
