...
public class ChatFilter {
	...
	public static void unpack(Archive archive) {
		JagBuffer class50_sub1_sub2 = new JagBuffer(archive.get("fragmentsenc.txt"));
		JagBuffer class50_sub1_sub2_1 = new JagBuffer(archive.get("badenc.txt"));
		JagBuffer class50_sub1_sub2_2 = new JagBuffer(archive.get("domainenc.txt"));
		JagBuffer class50_sub1_sub2_3 = new JagBuffer(archive.get("tldlist.txt"));
		method374(class50_sub1_sub2, class50_sub1_sub2_1, class50_sub1_sub2_2, class50_sub1_sub2_3);
	}

	public static void method374(JagBuffer class50_sub1_sub2, JagBuffer class50_sub1_sub2_1,
			JagBuffer class50_sub1_sub2_2, JagBuffer class50_sub1_sub2_3) {
	...
	public static void method375(JagBuffer class50_sub1_sub2, int i) {
		int j = class50_sub1_sub2.getInt();
		aCharArrayArray744 = new char[j][];
		anIntArray745 = new int[j];
		for (int k = 0; k < j; k++) {
			anIntArray745[k] = class50_sub1_sub2.getByte();
			char ac[] = new char[class50_sub1_sub2.getByte()];
			for (int l = 0; l < ac.length; l++)
				ac[l] = (char) class50_sub1_sub2.getByte();
	...
	public static void method376(boolean flag, JagBuffer class50_sub1_sub2) {
		if (!flag) {
			return;
		} else {
	...
	public static void method377(int i, JagBuffer class50_sub1_sub2) {
		int j = class50_sub1_sub2.getInt();
	...
	public static void method379(int i, JagBuffer class50_sub1_sub2, char ac[][], byte abyte0[][][]) {
		for (int j = 0; j < ac.length; j++) {
			char ac1[] = new char[class50_sub1_sub2.getByte()];
			for (int k = 0; k < ac1.length; k++)
				ac1[k] = (char) class50_sub1_sub2.getByte();

			ac[j] = ac1;
			byte abyte1[][] = new byte[class50_sub1_sub2.getByte()][2];
			for (int l = 0; l < abyte1.length; l++) {
				abyte1[l][0] = (byte) class50_sub1_sub2.getByte();
				abyte1[l][1] = (byte) class50_sub1_sub2.getByte();
			}
	...
	public static void method380(JagBuffer class50_sub1_sub2, char ac[][], int i) {
		if (i != -37125)
			anInt728 = 218;
		for (int j = 0; j < ac.length; j++) {
			char ac1[] = new char[class50_sub1_sub2.getByte()];
	...
	public static String applyCensor(byte byte0, String s) {
