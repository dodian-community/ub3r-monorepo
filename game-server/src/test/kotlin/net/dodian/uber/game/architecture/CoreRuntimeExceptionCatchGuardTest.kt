...
class CoreRuntimeExceptionCatchGuardTest {
    ...
    private fun coreRuntimeTargets(): List<Path> =
        listOf(
            ...
            Path.of("src/main/kotlin/net/dodian/uber/game/persistence/WorldPollPublisher.kt"),
            ...
            Path.of("src/main/kotlin/net/dodian/uber/game/systems/content/objects/ObjectInteractionService.kt"),
            Path.of("src/main/kotlin/net/dodian/uber/game/systems/content/npcs/NpcContentDispatcher.kt"),
            Path.of("src/main/kotlin/net/dodian/uber/game/systems/content/items/ItemDispatcher.kt"),
