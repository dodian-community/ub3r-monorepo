...
fun Client.checkSlayerTask(npcId: Int): Boolean {
    val slayerTask = net.dodian.uber.game.content.skills.slayer.SlayerTaskDefinition.forNpc(npcId)
    val slayExceptions = (slayerTask == null)
            || (slayerTask == net.dodian.uber.game.content.skills.slayer.SlayerTaskDefinition.MUMMY && getPositionName(position) == Player.positions.KEYDUNG)
