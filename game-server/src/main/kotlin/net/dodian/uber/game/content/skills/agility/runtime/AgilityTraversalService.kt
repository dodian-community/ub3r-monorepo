package net.dodian.uber.game.content.skills.agility.runtime

import net.dodian.uber.game.content.skills.runtime.SkillActionContext
import net.dodian.uber.game.content.skills.runtime.SkillTraversalMovementMode
...
object AgilityTraversalService {
    ...
    fun execute(
        ...
        if (movement.movementAnimationId != null) {
            player.setWalkAnim(movement.movementAnimationId)
        }
        when (movement.mode) {
