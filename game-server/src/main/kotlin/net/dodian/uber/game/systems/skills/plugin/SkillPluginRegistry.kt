...
object SkillPluginRegistry : ContentBootstrap {
    ...
    private fun rebuildSnapshotLocked() {
        ...
        val objectPresetById = HashMap<Int, MutableSet<net.dodian.uber.game.systems.action.PolicyPreset>>()
...
data class SkillPluginSnapshot(
    ...
    fun firstPresetForObjectId(objectId: Int): net.dodian.uber.game.systems.action.PolicyPreset? =
