...
public class WalkToTask {
    ...
    public enum Action {
        OBJECT_FIRST_CLICK, OBJECT_SECOND_CLICK, OBJECT_THIRD_CLICK, OBJECT_FOURTH_CLICK, NPC_FIRST_CLICK, NPC_SECOND_CLICK, NPC_THIRD_CLICK, ITEM_ON_OBJECT, ITEM_ON_NPC, ATTACK_NPC, ATTACK_PLAYER;
    }
