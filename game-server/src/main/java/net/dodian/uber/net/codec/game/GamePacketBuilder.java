...
import net.dodian.utilities.BufferUtil;
...
public final class GamePacketBuilder {
	 ...
	 */
	private void checkBitAccess() throws Exception {
	 ...
	 */
	private void checkByteAccess() throws Exception {
	 ...
	 */
	public void put(DataType type, DataOrder order, DataTransformation transformation, Number value) throws Exception {
		checkByteAccess();
	 ...
	 * @param value The value.
	 */
	public void put(DataType type, DataOrder order, Number value) throws Exception {
	 ...
	 * @param value The value.
	 */
	public void put(DataType type, DataTransformation transformation, Number value) throws Exception {
	 ...
	 * @param value The value.
	 */
	public void put(DataType type, Number value) throws Exception {
	 ...
	 * @param flag The flag.
	 */
	public void putBit(boolean flag) throws Exception {
		putBit(flag ? 1 : 0);
	}
	 ...
	 * @param value The value.
	 */
	public void putBit(int value) throws Exception {
		putBits(1, value);
	}
	 ...
	 */
	public void putBits(int numBits, int value) throws Exception {
	 ...
	 * @param bytes The byte array.
	 */
	public void putBytes(DataTransformation transformation, byte[] bytes) throws Exception {
	 ...
	 * @param bytes The byte array.
	 */
	public void putBytesReverse(byte[] bytes) throws Exception {
		checkByteAccess();
	 ...
	 * @param buffer The source {@link ByteBuf}.
	 */
	public void putBytesReverse(ByteBuf buffer) throws Exception {
		byte[] bytes = new byte[buffer.readableBytes()];
		buffer.markReaderIndex();
		try {
			buffer.readBytes(bytes);
	 ...
	 * @param bytes The byte array.
	 */
	public void putBytesReverse(DataTransformation transformation, byte[] bytes) throws Exception {
		if (transformation == DataTransformation.NONE) {
			putBytesReverse(bytes);
		} else {
			for (int i = bytes.length - 1; i >= 0; i--) {
	 ...
	 */
	public void putRawBuilder(GamePacketBuilder builder) throws Exception {
		checkByteAccess();
	 ...
	 * @throws IllegalArgumentException If the builder is not raw.
	 */
	public void putRawBuilderReverse(GamePacketBuilder builder) throws Exception {
		checkByteAccess();
	 ...
	 * @param value The value.
	 */
	public void putSmart(int value) throws Exception {
		checkByteAccess();
		if (value < 128) {
	 ...
	 */
	public void switchToBitAccess() throws Exception {
		if (mode == AccessMode.BIT_ACCESS)
	 ...
	 */
	public void switchToByteAccess() throws Exception {
		if (mode == AccessMode.BYTE_ACCESS)
	...
	public GamePacket toGamePacket() {
		...
		return new GamePacket(opcode, type, buffer, buffer.readableBytes());
	}
