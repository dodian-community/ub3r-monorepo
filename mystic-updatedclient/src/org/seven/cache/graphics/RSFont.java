...
public class RSFont extends Rasterizer2D {
    ...
    public void drawRightString(String string, int drawX, int drawY, int color,
            int shadow, RSFont font) {
        if (string != null) {
            setColorAndShadow(color, shadow);
            drawBasicString(string, drawX - font.getTextWidth(string), drawY);
        }
    }
